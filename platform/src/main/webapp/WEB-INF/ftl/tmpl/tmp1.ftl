...
<head>
    ...
    <script src="../../../resources/static/js/jquery/1.11.3/jquery-1.11.3.min.js"></script>
            ...
            <ul class="nav navbar-nav pull-right" role="navigation">
                <#if currentUser??>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="/user/${currentUser.id}">USER details</a></li>
                            <li><a href="/user/${currentUser.id}">USER manage</a></li>
                            <li role="separator" class="divider"></li>
