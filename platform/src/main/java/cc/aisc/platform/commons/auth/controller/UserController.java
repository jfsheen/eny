...
import cc.aisc.platform.commons.auth.validator.UserCreateFormValidator;
...
public class UserController/* extends BaseController */{
    ...
    public ModelAndView handleUserCreateForm(@Valid @ModelAttribute("form") UserDto form, BindingResult bindingResult) {
